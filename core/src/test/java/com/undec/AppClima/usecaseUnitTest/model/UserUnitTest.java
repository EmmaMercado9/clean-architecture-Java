...
public class UserUnitTest {
    ...
    void instance_missingName_UserIncompleteException() {
        ...
        Exception exceptionEmpty = assertThrows(ExceptionUserIncomplete.class, () -> User.instance("","emamerc@gmail.com","Hola1234*",LocalDate.of(2003,1,21),"Argentina"));
    ...
    void instance_missingMail_UserIncompleteException() {
        ...
        Exception exceptionEmpty = assertThrows(ExceptionUserIncomplete.class, () -> User.instance("Emmanuel","","Hola1234*",LocalDate.of(2003,1,21),"Argentina"));
    ...
    void instance_missingPassword_UserIncompleteException() {
        ...
        Exception exceptionEmpty = assertThrows(ExceptionUserIncomplete.class, () -> User.instance("Emmanuel","emamerc@gmail.com","",LocalDate.of(2003,1,21),"Argentina"));
